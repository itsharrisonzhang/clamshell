...
# Complex redirection
    ...
    [ 'Test REDIR19',
      'redirection placement',
      'echo 1> out1.txt the redirection can occur anywhere && cat out1.txt',
      'the redirection can occur anywhere' ],

    [ 'Test REDIR20',
      'redirection error command status',
      'echo >> out2.txt the redirection can occur anywhere && cat out2.txt',
      'No such file or directory' ],

    [ 'Test REDIR21',
      'redirection error command status',
      'echo 2>> out3.txt the redirection can occur anywhere && cat out3.txt',
      'No such file or directory' ],

    [ 'Test REDIR22',
      'redirection error command status',
      'echo Hello 1> nonexistent%%.txt && echo Unwanted',
      'Unwanted',
      CMD_CLEANUP => 'perl -pi -e "s,^.*:\s*,," out%%.txt' ],
    ...
    [ 'Test REDIR24',
      'redirection error command status',
      'echo Hello 2>> nonexistent%%.txt && echo Unwanted',
      'No such file or directory',
      CMD_CLEANUP => 'perl -pi -e "s,^.*:\s*,," out%%.txt' ],
...
# check for a ton of existing sh processes
$me = `id -un`;
chomp $me;
